...
abstract class DomainObject
{
    ...
    // Boolean whether domain objects should generate exception when a reference to an unknown field/property happens
    ...
    Will generate exception if passed name doesnt exist in field list 
    (which is defined by the concrete subclass)
    ...
    */
    ...
    PHP magic function that gets the value assigned to the specified field via the corresponding getter (if it exists);
